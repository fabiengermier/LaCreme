...
*/
   ...
   document.getElementById("streamers").innerHTML = streamers.map(stream => `
    <a href="https://twitch.tv/${stream.user_name}" target="_blank" class="border bg-white rounded shadow hover:shadow-lg max-w-[340px] pt-[10px] px-[10px] mx-auto" style="max-width:63%">
      <img src="${stream.thumbnail_url.replace('{width}', '320').replace('{height}', '180')}" class="w-[320px] h-[180px] object-cover rounded" style="margin-top:5px;"/>
